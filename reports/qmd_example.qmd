...
*Note: this report is adapted from @timbers-horses.*

# Results

![Horse populations for all provinces in Canada from 1906–1972.](../results/horse_pops_plot.png){#fig-horse-pop fig-width=70% fig-pos="H"}
...
![Horse populations for the province with the largest standard deviation.](../results/horse_pop_plot_largest_sd.png){#fig-horse-pop-largest fig-width=70% fig-pos="H"}

In @fig-horse-pop-largest we zoom in and look at the province of `r largest_sd`, which had the largest spread of values in terms of standard deviation.
