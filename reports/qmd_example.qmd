...
![Horse populations for all provinces in Canada from 1906–1972.](../results/horse_pops_plot.png){#fig-horse-pop fig-width=7 fig-pos="H"}
...
![Horse populations for the province with the largest standard deviation.](../results/horse_pop_plot_largest_sd.png){#fig-horse-pop-largest fig-width=7 fig-pos="H"}
